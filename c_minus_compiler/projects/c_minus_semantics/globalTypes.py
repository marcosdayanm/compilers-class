...
class SyntaxNodeType(Enum):
    ...
    DECLARATION_LIST_PRIME = "declaration_list_prime"
    ...
    PARAM_LIST_PRIME = "param_list_prime"
    PARAM = "param"
    COMPOUND_STMT = "compound_stmt"
    LOCAL_DECLARATIONS = "local_declarations"
    LOCAL_DECLARATIONS_PRIME = "local_declarations_prime"
    STATEMENT_LIST = "statement_list"
    STATEMENT_LIST_PRIME = "statement_list_prime"
    STATEMENT = "statement"
...
DECLARATION_STARTS: frozenset[TokenType] = frozenset({TokenType.INT, TokenType.VOID})
TYPE_SPECIFIERS: frozenset[TokenType] = frozenset({TokenType.INT, TokenType.VOID})
STATEMENT_STARTS: frozenset[TokenType] = frozenset(
    {
        TokenType.ID,
        TokenType.NUM,
        TokenType.LPAREN,
...
EXPRESSION_STARTS: frozenset[TokenType] = frozenset({TokenType.ID, TokenType.NUM, TokenType.LPAREN})
RELOPS: frozenset[TokenType] = frozenset({TokenType.LTE, TokenType.LT, TokenType.GT, TokenType.GTE, TokenType.EQ, TokenType.NEQ})
ADDOPS: frozenset[TokenType] = frozenset({TokenType.PLUS, TokenType.MINUS})
MULOPS: frozenset[TokenType] = frozenset({TokenType.TIMES, TokenType.OVER})
